		...
		Properties: map[string]any{
			...
			"items": map[string]any{
				...
				"items": map[string]any{
					...
					"required": []string{"raw_name", "store_item_code", "receipt_description", "upc", "suggested_name", "suggested_brand", "suggested_tags", "suggested_category", "quantity", "unit", "unit_price", "total_price", "regular_price", "discount_amount", "line_number", "confidence"},
				},
			},
