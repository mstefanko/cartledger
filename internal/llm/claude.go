			...
			"items": map[string]any{
				...
				"items": map[string]any{
					...
					"properties": map[string]any{
						...
						"upc":                 map[string]any{"type": []any{"string", "null"}, "description": "product barcode/UPC/GTIN if explicitly printed for this line item; digits only"},
						"package_label":       map[string]any{"type": []any{"string", "null"}, "description": "explicit package content printed on the receipt line, such as 12 OZ, 1GAL, 16 CT, or 2 x 8 ct; null if not printed"},
						"package_quantity":    map[string]any{"type": []any{"string", "null"}, "description": "numeric package quantity from explicit package text only; preserve decimal text when present"},
						"package_unit":        map[string]any{"type": []any{"string", "null"}, "description": "package unit from explicit package text only, such as oz, fl_oz, lb, g, ml, l, gal, each, or ct"},
					...
					"required": []string{"raw_name", "store_item_code", "receipt_description", "upc", "package_label", "package_quantity", "package_unit", "suggested_name", "suggested_brand", "suggested_tags", "suggested_category", "quantity", "unit", "unit_price", "total_price", "regular_price", "discount_amount", "line_number", "confidence"},
				},
			},
