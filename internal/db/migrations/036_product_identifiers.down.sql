...
UPDATE line_items SET matched = 'alias' WHERE matched = 'identifier';
...
CREATE TABLE line_items_new (
    ...
    matched              TEXT DEFAULT 'unmatched' CHECK (matched IN ('unmatched','auto','manual','rule','alias','fuzzy','code')),
    confidence           REAL,
    line_number          INTEGER,
...
DROP TABLE IF EXISTS line_item_identifier_observations;
